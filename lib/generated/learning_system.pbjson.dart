...
const Answer$json = const {
  ...
  '2': const [
    ...
    const {'1': 'text', '3': 4, '4': 1, '5': 5, '10': 'text'},
  ],
};

/// Descriptor for `Answer`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List answerDescriptor = $convert.base64Decode('CgZBbnN3ZXISDgoCaWQYASABKAVSAmlkEiIKB3N0dWRlbnQYAiABKAsyCC5TdHVkZW50UgdzdHVkZW50EiUKCHF1ZXN0aW9uGAMgASgLMgkuUXVlc3Rpb25SCHF1ZXN0aW9uEhIKBHRleHQYBCABKAVSBHRleHQ=');
